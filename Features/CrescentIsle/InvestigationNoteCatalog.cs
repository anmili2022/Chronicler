...
internal static class InvestigationNoteCatalog
{
    ...
    [
        ...
        Note(11, "魔法罐 FATE"), NoteAt(12, "新月岛南部 (X: 23.2, Y: 21.5)", ExpeditionMap.South, 6),
        NoteAt(13, "新月岛南部 (X: 10.2, Y: 22.5)", ExpeditionMap.South, 3), Note(14, "CE：双极的造物——神秘土偶"),
        NoteAt(15, "新月岛南部 (X: 24.1, Y: 33.0)", ExpeditionMap.South, 4), Note(16, "CE：黑色连队"),
        Note(17, "CE：愤怒的人造人——新月狂战士"), NoteAt(18, "新月岛南部 (X: 18.6, Y: 33.8)", ExpeditionMap.South, 7),
        NoteAt(19, "新月岛南部 (X: 15.6, Y: 29.4)", ExpeditionMap.South, 5), Note(20, "CE：挣脱封印的大妖异——回廊恶魔"),
        NoteAt(21, "新月岛南部 (X: 36.5, Y: 33.7)", ExpeditionMap.South, 10), NoteAt(22, "新月岛南部 (X: 36.0, Y: 22.6)", ExpeditionMap.South, 11),
        NoteAt(23, "新月岛南部 (X: 3.7, Y: 5.8)", ExpeditionMap.South, 9), NoteAt(24, "新月岛南部 (X: 8.7, Y: 35.8)", ExpeditionMap.South, 8),
