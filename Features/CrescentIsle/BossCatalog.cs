...
internal static class BossCatalog
{
    ...
    [
        CreateCe(ExpeditionMap.North, 101, 0, "变形法师", "拟态使魔——变形法师", "待收集 x:31.4, y:15.2", "γ"),
        CreateCe(ExpeditionMap.North, 102, 1, "亡灵法师", "天道好轮回——魔亡灵法师", "Lv.27 新月幽灵(注意位置) x:25.9, y:4.2", "β"),
        CreateCe(ExpeditionMap.North, 103, 2, "古术魔典", "禁书化形——古术魔典", "Lv.22 新月永世珍本(x:35.0 y:31.0)  x:34.6, y:34.6", "α"),
        CreateCe(ExpeditionMap.North, 104, 3, "阿尔戈尔", "暴食咒鬼——阿尔戈尔", "待收集 x:36.7, y:21.4", "β"),
        CreateCe(ExpeditionMap.North, 105, 4, "岛主", "孤岛的绑架犯——诱拐魔", "Lv.27 新月幽灵(注意位置) x:18.4, y:4.2", "γ", "诱拐魔"),
        CreateCe(ExpeditionMap.North, 106, 5, "雪石膏之剑", "纯白守护者——雪石膏之剑", "待收集 x:11.1, y:8.6", "β"),
        CreateCe(ExpeditionMap.North, 107, 6, "小小法师", "魔法军团——小小法师", "待收集 x:24.5, y:35.7", "β"),
        CreateCe(ExpeditionMap.North, 108, 7, "神木巨人", "求道的人造人——神木巨人", "待收集 x:13.6, y:35.4", "γ"),
        CreateCe(ExpeditionMap.North, 109, 8, "魔许德拉", "苏醒的多头龙——魔许德拉", "待收集 x:19.8, y:31.1", "α"),
        CreateCe(ExpeditionMap.North, 110, 9, "负隅宝石兽", "叛逆使魔——负隅宝石兽", "待收集 x:26.2, y:28.5", "γ"),
        CreateCe(ExpeditionMap.North, 111, 10, "惨白魔人", "诅咒的继承者——惨白魔人", "待收集 x:37.6, y:10.2", "α"),
        ...
        CreateFate(ExpeditionMap.North, 116, 15, 2073, "左下罐", "被吹飞的魔法罐（左下罐）", "待收集 x:11.3, y:26.2", "金", "被吹飞的魔法罐"),
        CreateFate(ExpeditionMap.North, 117, 16, 2072, "右上罐", "被欺负的魔法罐（右上罐）", "待收集 x:26.1, y:12.1", "金", "被欺负的魔法罐"),
    ];
