...
internal static class BossCatalog
{
    ...
    [
        ...
        CreateCe(ExpeditionMap.North, 112, 11, "二重身", "魔女复制体--卡洛菲斯提莉二重身", "新月帕尔忒诺珀(推测1)/Lv39 黑卫(推测2) x:17.1, y:20.1", "魔女复制体", "卡洛菲斯提莉二重身"),
        CreateCe(ExpeditionMap.North, 113, 12, "提蔛", "四颚斧花--提蔛", "Lv.46 新月瓦魔蛾 x:4.0, y:10.2"),
        CreateCe(ExpeditionMap.North, 114, 13, "赤龙", "暗红尸骸--赤龙", "Lv.34 大角牛 x:7.7, y:24.4", "暗红尸骸"),
